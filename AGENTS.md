...
- Do not use Slack Socket Mode for any manifest or Slack integration in this project. Use Slack HTTP Events API / slash-command webhooks behind a TrueFoundry HTTP `Service`.
