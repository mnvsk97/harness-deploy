...
OPENSWE_ENVSUBST_VARS := '$$TFY_WORKSPACE_FQN $$HARNESS_DEPLOY_ROOT $$TFY_SECRET_TENANT $$TFY_GATEWAY_SECRET_GROUP $$CODEX_GATEWAY_SECRET_GROUP $$OPENSWE_SECRET_GROUP $$OPENSWE_API_HOST $$OPENSWE_DEFAULT_REPO'
...
OPENSWE_SLACK_ENVSUBST_VARS := '$$TFY_WORKSPACE_FQN $$HARNESS_DEPLOY_ROOT $$TFY_SECRET_TENANT $$CODEX_GATEWAY_SECRET_GROUP $$OPENSWE_API_HOST $$OPENSWE_SLACK_HOST $$OPENSWE_SLACK_SECRET_GROUP $$OPENSWE_SLACK_STORAGE_CLASS'
